...
export default function HeroEpInfo({ title, statistics }: HeroEpInfoProps) {
    return (
        <motion.div 
            ...
            className="size-full text-inherit flex flex-col justify-between gap-1"
        >
            ...
            <div className="self-end inline-flex p-3 gap-3 text-sm font-medium">
                <div className="inline-flex justify-center items-center gap-1.5 p-1">
                    <span><Icon name="Like" className="text-[10px]" /></span>
                    <p>
                        {Number(statistics.viewCount).toLocaleString()}
                    </p>
                </div>
                <div className="inline-flex justify-center items-center gap-1.5 p-1">
                    <span><Icon name="View" className="text-[10px]" /></span>
                    <p>
                        {Number(statistics.likeCount).toLocaleString()}
                    </p>
                </div>
                <div className="inline-flex justify-center items-center gap-1.5 p-1">
                    <span><Icon name="Comment" className="text-[10px]" /></span>
                    <p>
